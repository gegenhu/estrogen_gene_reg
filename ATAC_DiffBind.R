...
ATAC_mEBvfCO <- dba.report(ATAC_count,contrast = 5,th=0.05,fold=1,method = DBA_EDGER,bFlip = TRUE)
ATAC_fEBvfCO <- dba.report(ATAC_count,contrast = 7,th=0.05,fold=1,method = DBA_EDGER,bFlip = TRUE)
ATAC_fEBvmCO <- dba.report(ATAC_count,contrast = 6,th=0.05,fold=1,method = DBA_EDGER,bFlip = TRUE)
